  ...
  function addRoom()
    {
        ...
        firebase.database().ref("/").child(room_name).update({ // this is used to to store the data in database 
              purpose : "adding room name"
        });
        localStorage.setItem("room-name" , room_name);  // this will set the key and value in the local storage
